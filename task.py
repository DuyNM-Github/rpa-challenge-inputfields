...
driver.get("http://www.rpachallenge.com")  # navigate to site
...
def readExcelFile():
    ...
    try:
        ...
        lib.close_workbook()
        startBtn = driver.find_element(By.TAG_NAME, 'button')
...
def inputToBrowser():
    global counter
    inputFieldsContainer = driver.find_element(By.CLASS_NAME, 'inputFields')
